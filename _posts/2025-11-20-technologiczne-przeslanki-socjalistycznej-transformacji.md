---
title: Technologiczne przesłanki socjalistycznej transformacji
description: Kapitalizm w znanej nam formie przestanie istnieć. Pytanie nie brzmi "czy", ale "kiedy" pęknie bańka i nastąpi przejście do nowej fazy cyklu dziejowego, czy strategia Chin ten proces przyspiesza?
layout: post
lang: pl
date: 2025-11-20
permalink: /pl/blog/technologiczne-przeslanki-socjalistycznej-transformacji/
...
- **Problem "czarnej skrzynki"**: Zamknięte rozwiązania (np. GPT-4 od OpenAI) nie gwarantują monopolu. Konkurencja oraz sektor open-source są w stanie przeprowadzić "destylację" wiedzy – analizując zachowania wejścia/wyjścia modelu zamkniętego, tworzą własne, lepsze i tańsze odpowiedniki.
- **Dyfuzja zysku**: Badania wskazują, że twórca innowacji przejmuje jedynie mniejszość wygenerowanej wartości (często 1/3), reszta trafia do konkurencji i konsumentów. Oznacza to, że w przypadku AI koszt krańcowy (koszt wytworzenia kolejnej jednostki produktu) przestaje istnieć, co uniemożliwia utrzymanie wysokich cen i marż w dłuższym okresie.
- **Nierentowność**: Jeśli wiedza staje się dobrem powszechnym i darmowym, kapitalista traci możliwość uzyskania zysku z jej eksploatacji.
...
- Pracownik otrzymuje pensję, która wystarcza na jego przeżycie (np. 200 zł dniówki).
- W trakcie dnia pracy pracownik wytwarza towary o wartości znacznie wyższej (np. 400 zł).
- Różnica (200 zł) to wartość dodatkowa. Jest to darmowa praca, którą kapitalista przejmuje. To jest jedyne paliwo zasilające system.

### Dlaczego maszyna nie tworzy wartości dodatkowej

Kapitalista zastępuje grafika komputerowego generatorem obrazów AI.

- Maszyna/AI kosztuje tyle, ile wynosi jej produkcja i eksploatacja (prąd, amortyzacja sprzętu, licencja).
- Jeśli koszt wygenerowania obrazka to 1 grosz (prąd + zużycie GPU), to maszyna przenosi na produkt wartość dokładnie 1 grosza.
- Maszyny nie da się "wyzyskiwać". Nie można jej zmusić do darmowej pracy ponad koszt jej zasilania. Maszyna oddaje dokładnie tyle wartości, ile pobiera. Źródło darmowej nadwyżki znika.

### Dlaczego cena spada do zera

Tu pojawia się kluczowy moment, często pomijany w analizach:

- **Początek (złudzenie zysku):** Pierwsza firma wdraża AI. Zwalnia ludzi, koszty spadają drastycznie, ale firma utrzymuje stary cennik rynkowy. Notuje gigantyczny, nadzwyczajny zysk.
- **Reakcja rynku:** Konkurencja widzi tę marżę i natychmiast wdraża te same modele AI (jest to łatwe, bo bariera wejścia jest niska).
- **Wyrównanie:** Ponieważ wszyscy mają teraz zerowe koszty produkcji (AI robi to za darmo), zaczynają walczyć ceną, by zdobyć klienta.
- **Finał:** Cena usługi spada do poziomu kosztu prądu (kosztu krańcowego). Marża zysku wyparowuje.

System wchodzi w stan sprzeczności:

- Mianownik rośnie: Firmy wydają fortunę na infrastrukturę (centra danych, Nvidia H100) – rośnie tzw. organiczny skład kapitału.
- Licznik maleje: Z procesu usuwani są ludzie, czyli jedyny czynnik, który mógł wytworzyć zysk netto.
...
- Kapitaliści zwalniają ludzi, zastępując ich AI (żeby obniżyć koszty).
- Zwolnieni pracownicy tracą siłę nabywczą.
- Jeśli kapitaliści sztucznie utrzymają wysokie ceny towarów, a społeczeństwo (pozbawione pracy przez AI) nie będzie miało płac, nastąpi kryzys nadprodukcji.
- Towary będą leżeć na "półkach". System się zatka, bo nie będzie komu "zrealizować" zysku (czyli kupić produktu). Popyt efektywny spadnie do zera.
...
- To stwarza potężną pokusę dla jednego z uczestników zmowy, by się wyłamać.
- Jeśli jeden kapitalista obniży cenę o 10%, przejmie cały rynek. Ponieważ koszt powielenia usługi cyfrowej jest żaden, może obsłużyć miliardy klientów natychmiast.
- Chciwość – główny silnik kapitalizmu – sprawia, że kartele technologiczne są nietrwałe.
