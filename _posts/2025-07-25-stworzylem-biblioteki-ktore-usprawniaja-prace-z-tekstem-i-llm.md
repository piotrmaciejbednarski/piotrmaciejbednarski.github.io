...
## Biblioteka text-similarity-node
...
## Weryfikacja algorytmów i biblioteka referencyjna
...
## Problemy z pakowaniem i implementacja SIMD
...
## Benchmarki i zastosowanie w realnym świecie
